...
/**
 * weather set
 * code forked from https://codepen.io/Gerwinnz/pen/RVzrRG
 */
...
// rain
var rainColor = 'rgba(255, 255, 255, .4)';
...
cloud.prototype.draw = function()
{
  ...
  context.drawImage(this.img.image, 0, 0, this.img.width, this.img.height, this.x, this.y, this.img.width, this.img.height);
